...
//				
//			} else {
//				myEPlayer.sendMessage("You must be the owner of the empire to change ranks");
//			}			
//		} else {
//			myEPlayer.sendMessage("You are not in an empire!");
//		}
//		
...
//		return false;
	...
	private void sendPerms(Player player) {
